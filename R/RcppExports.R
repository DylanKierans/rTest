...
set_ports <- function(ports) {
    .Call('_rTrace_set_ports', PACKAGE = 'rTrace', ports)
}
...
#' @return R_NilValue
evtWriter_proc_client <- function(proc_init) {
    .Call('_rTrace_evtWriter_proc_client', PACKAGE = 'rTrace', proc_init)
}
...
#' get_pgid
get_pgid <- function() {
    .Call('_rTrace_get_pgid', PACKAGE = 'rTrace')
}
...
test__signal <- function(signal_proc, is_master = TRUE) {
    .Call('_rTrace_test__signal', PACKAGE = 'rTrace', signal_proc, is_master)
}
...
#' @return R_NilValue
r_report_and_exit <- function(msg) {
    .Call('_rTrace_r_report_and_exit', PACKAGE = 'rTrace', msg)
}
